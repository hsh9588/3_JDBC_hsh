...
-- 사용자 계정 사용
CREATE USER member_hsh IDENTIFIED BY member1234;

-- 생성한 사용자 계정에 권한 부여
GRANT CONNECT, RESOURCE, CREATE VIEW TO member_hsh;

-- 테이블 스페이스 할당 
ALTER USER member_hsh DEFAULT 
...
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 2번', DEFAULT, DEFAULT, 1, 1);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 3번', DEFAULT, DEFAULT, 1, 1);
...
SELECT BOARD_NO, BOARD_TITLE, MEMBER_NM, READ_COUNT, 
	CASE 
		...
		WHEN SYSDATE - CREATE_DT < 7
		THEN FLOOR(SYSDATE - CREATE_DT) || '일 전'
...
SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT,
	MEMBER_NO, MEMBER_NM, READ_COUNT 조회수,
	(SELECT COUNT(*) FROM "COMMENT" C
	WHERE C.BOARD_NO = B.BOARD_NO) 댓글수,
...
SELECT COMMENT_NO, COMMENT_CONTENT, MEMBER_NO,
	MEMBER_NM, TO_CHAR(CREATE_DT, 'YYYY-MM-DD HH24:MI:SS') CREATE_DT
FROM "COMMENT"
JOIN "MEMBER" USING(MEMBER_NO)
WHERE DELETE_FL = 'N'
AND BOARD_NO = 1
...
VALUES(SEQ_NO.NEXTVAL, ?, ?, ?) SEQ_NO.NEXTVAL
