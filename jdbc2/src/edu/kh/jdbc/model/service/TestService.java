...
// Service : 비지니스 로직(데이터 가공, 트랜젝션 제어) 처리
...
public class TestService {
	...
	public int insert(TestVO vo1, TestVO vo2, TestVO vo3) throws Exception {
		...
		int res = 0; // 모두 insert 3회 성공 시 1, 아니면 0
		
		try {
			// insert 중 오류가 발생하면 모든 insert내용 rollback
			// -> try-catch로 예외가 발생 했다는 것을 인지함.
			...
			throw new Exception("DAO 수행 중 오류 발생");
